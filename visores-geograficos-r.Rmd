...
### Slides 
[https://ajpelu.github.io/visores_geograficos_r/visores-geograficos-r.html](https://ajpelu.github.io/visores_geograficos_r/visores-geograficos-r.html)

### Material en `r fontawesome::fa("github")` [ajpelu/visores_geograficos_r](https://github.com/ajpelu/visores_geograficos_r)

### `r fontawesome::fa("map")` [https://ajpelu.github.io/visores_geograficos_r_ejemplo/](https://ajpelu.github.io/visores_geograficos_r_ejemplo/) 

---

### `r fa("github", fill = "steelblue")` Repo: ajpelu/visores_geograficos_r/
...
### b. Alojar el visor en Github
  ...
  - Desplegar desde tu repositorio.
  - Introducción a Git + Github + Repositorios 
    
    - [¡Se puede entender cómo funcionan Git y GitHub!](https://www.revistaecosistemas.net/index.php/ecosistemas/article/view/2332) Astigarraga & Cruz-Alonso (2022)
    - [¿Por qué usar GitHub? Diez pasos para disfrutar de GitHub y no morir en el intento](https://www.revistaecosistemas.net/index.php/ecosistemas/article/view/1604) Galeano (2018)
...
Ejemplo: https://ajpelu.github.io/visores_geograficos_r/ 

Otro ejemplo: https://ajpelu.github.io/qpyr_spatial_es/
...
### `r fontawesome::fa("github")` [ajpelu/qpyr_spatial_es/](https://github.com/ajpelu/qpyr_spatial_es)

https://ajpelu.github.io/qpyr_spatial_es/ 

### `r fontawesome::fa("github")` [ajpelu/visores_geograficos_r](https://github.com/ajpelu/visores_geograficos_r)

https://ajpelu.github.io/visores_geograficos_r 
...
[`r fontawesome::fa("link")` https://ajperezluque.com/](https://ajperezluque.com/)
