...
## Tipos de datos: *Modelo vectorial* 
...
.pull-left[- Limitaciones<sup>1</sup>: 
  - Formato multiarchivo (al menos: `.shp`, `.dbf`, `.shx`)
  - No se define por defecto el sistema de referencia de coordenadas (`.prj`) 
  - Nombre de los atributos limitado a 10 carácteres
  - ... 
  
- ~80 formatos de datos vectoriales:
...
knitr::include_graphics("img/ban-shapefile.png")
```
.footnote[ 
[1] http://switchfromshapefile.org
] 

---

## Tipos de datos: *Modelo raster* 
...
# Recursos sobre R + Información Espacial
(... solo una "mijitica")
